...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        services.AddDbContext<Database>(options =>
            ...
            this.Configuration.GetConnectionString("Ingo"), options => options.EnableRetryOnFailure()));
        ...
        services.AddHttpClient("recaptcha", c => c.BaseAddress = new Uri("https://www.google.com/"));
